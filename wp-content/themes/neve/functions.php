...
function mi_tema_hijo_scripts() {
    ...
    // Enlazar el archivo CSS de tu tema (si es que tienes uno)
    wp_enqueue_style('mi-tema-hijo-style', get_stylesheet_uri());

    // Enlazar Bootstrap JS y Popper.js (necesarios para ciertos componentes de Bootstrap)
